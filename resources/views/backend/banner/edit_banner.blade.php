            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('update.banner',$banner->id) }}" id="myForm" enctype="multipart/form-data">
                            ...
                            <div class="mb-3 form-group">
                                ...
                                <a href="{{ route('delete.banner.image',['bid'=>$banner->id ,'id'=>1]) }}" class="btn align-top btn-sm btn-danger"> <i class="fa fa-trash"></i></a>
                            </div>
                            ...
                            <div class="mb-3 form-group">
                                ...
                                <a href="{{ route('delete.banner.image',['bid'=>$banner->id ,'id'=>2]) }}" class="btn align-top btn-sm btn-danger"> <i class="fa fa-trash"></i></a>
                            </div>
                            ...
                            <div class="mb-3 form-group">
                                ...
                                <a href="{{ route('delete.banner.image',['bid'=>$banner->id ,'id'=>3]) }}" class="btn align-top btn-sm btn-danger"> <i class="fa fa-trash"></i></a>
                            </div>
                            ...
                            <div class="mb-3 form-group">
                                ...
                                <a href="{{ route('delete.banner.image',['bid'=>$banner->id ,'id'=>4]) }}" class="btn align-top btn-sm btn-danger"> <i class="fa fa-trash"></i></a>
                            </div>
                            ...
                            <div class="mb-3 form-group">
                                ...
                                <a href="{{ route('delete.banner.image',['bid'=>$banner->id ,'id'=>5]) }}" class="btn align-top btn-sm btn-danger"> <i class="fa fa-trash"></i></a>
                            </div>

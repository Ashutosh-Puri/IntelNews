        ...
        <div class="row">
            <div class="col-lg-9 col-md-8">
                <div class="rachive-info-cats">
                    ...
                    @if ( $news[0]->categoryRelation != NULL)
                    ...
                    @endif
                    @if ( $news[0]->subcategoryRelation != NULL)
                        <i class="las la-chevron-right"></i>  
                        <a href="{{ url('news/subcategory/'.$news[0]->subcategoryRelation->id.'/'.$news[0]->subcategoryRelation->subcategory_slug) }}" rel="category tag">{{ $news[0]->subcategoryRelation->subcategory_name }}</a>
                    @endif
                </div>
                <div class="row">
                                ...
                                <div class="archive-shadow arch_margin">
                                    <div class="archive1_image">
                                        ...
                                        <div class="archive1-meta">
                                            <a href="{{ url('news/details/'.$item->id.'/'.$item->news_title_slug) }} "><i class="la la-tags"> </i>{{ $item->created_at->format('l M d Y') }}</a>
                                        </div>
                                    </div>
